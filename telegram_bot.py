...
# URL для анализа лица (API нашего 
FACE_ANALYZER_URL = "https://face-1-guks.onrender.com/analyze" # gunicorn сервер работает на порту 5000# gunicorn сервер работает на порту 5000
